...
BEGIN
   ...
   SELECT DISTINCT Country, 'EXPORT_FOOTWEAR' FROM [dbo].[OTEXA_EXPORT_FOOTWEAR] UNION ALL
   SELECT DISTINCT Country, 'MERGED_CAT' FROM [dbo].[OTEXA_MERGED_CAT] UNION ALL
   SELECT DISTINCT Country, 'PART_CAT' FROM [dbo].[OTEXA_PART_CAT]
