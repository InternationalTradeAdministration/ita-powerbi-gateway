  ...
  methods: {
    ...
    async viewReport () {
      ...
      if (this.selectedCountries.length > 0) {
        ...
        filters.push(this.filter('Country', 'In', selectedCountries, false, this.onlyCountry))
      } else {
      ...
      if (this.selectedCategories.length > 0) {
        ...
        filters.push(this.filter('Category', 'In', selectedCategories, false, !this.onlyCountry))
      } else {
