...
DROP TABLE IF EXISTS [dbo].[BEA_ITA_DATA]
GO

CREATE TABLE [dbo].[BEA_ITA_DATA]
(
...
DROP TABLE IF EXISTS [dbo].[BEA_INTLSERVTRADE_DATA]
GO

CREATE TABLE [dbo].[BEA_INTLSERVTRADE_DATA]
(
